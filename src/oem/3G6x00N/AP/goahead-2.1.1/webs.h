...
// for debug, david ----------------
#define DBFENTER        printf("%s: Enter\n", __FUNCTION__);
#define DBFEXIT         printf("%s: Exit\n", __FUNCTION__);
//-----------------------------------
...
#define WEBS_BUFSIZE                    2048            /* websWrite max output string */
#define WEBS_MAX_HEADER                 (5 * 1024)      /* Sanity check header */
#define WEBS_MAX_URL                    4096            /* Maximum URL size for sanity */
#define WEBS_SOCKET_BUFSIZ              256 //joseph 256->512                   /* Bytes read from socket */
...
#define WEBS_SOAPACTION                 0x100000
#define WEBS_HNAP_HTTP                  0x200000 
/*
 *      URL handler flags
 */
