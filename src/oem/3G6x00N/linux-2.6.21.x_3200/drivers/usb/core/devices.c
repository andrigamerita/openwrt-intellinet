 ...
 *
 * $Id: devices.c,v 1.1.1.1 2007-05-25 06:50:07 bruce Exp $
 */
				...
				struct usb_device *usbdev, struct usb_bus *bus, int level, int index, int count)
{
	...
	/* tommy ==> we don't want to list usb hubs information */
	if (usbdev->descriptor.bDeviceClass != USB_CLASS_HUB) { // tommy add
